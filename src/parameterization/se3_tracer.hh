...
inline auto trace_interpolate_impl(
    const std::string &language,
...
inline auto trace_interpolate(const std::string &language) -> Traced
{
    return trace_interpolate_impl(
        language, {{"a", 8, true}, {"b", 8, true}, {"t", 1, false}}, {});
}

inline auto trace_interpolate_block(const std::string &language) -> Traced
{
...
inline auto read_transform(const ADVectorXs &inp, std::size_t offset) -> SE3Tpl<ADCG>
{
...
inline auto se3_displacement(const SE3Tpl<ADCG> &transform) -> ADVectorXs
{
...
inline auto trace_SE3_distance(const std::string &language) -> Traced {
